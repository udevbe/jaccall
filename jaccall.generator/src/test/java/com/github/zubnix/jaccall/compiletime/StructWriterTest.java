...
public class StructWriterTest {
    ...
    public void testUnsignedLongField() {
        //given
        final JavaFileObject fileObject = JavaFileObjects.forSourceString("com.github.zubnix.libtest.struct.TestStructUnsignedLong",
                                                                          "package com.github.zubnix.libtest.struct;\n" +
                                                                          "\n" +
                                                                          "import com.github.zubnix.jaccall.CType;\n" +
                                                                          "import com.github.zubnix.jaccall.Field;\n" +
                                                                          "import com.github.zubnix.jaccall.Struct;\n" +
                                                                          "\n" +
                                                                          "import static com.github.zubnix.jaccall.CType.UNSIGNED_LONG;\n" +
                                                                          "\n" +
                                                                          "@Struct(value = {\n" +
        ...
        compileTester.compilesWithoutError()
                     .and()
                     .generatesSources(JavaFileObjects.forSourceString("com.github.zubnix.libtest.struct.TestStructUnsignedLong_Jaccall_StructType",
                                                                       "package com.github.zubnix.libtest.struct;\n" +
                                                                       "\n" +
                                                                       "import com.github.zubnix.jaccall.CLong;\n" +
                                                                       "import com.github.zubnix.jaccall.JNI;\n" +
    ...
    public void testLongLongField() {
        //given
        final JavaFileObject fileObject = JavaFileObjects.forSourceString("com.github.zubnix.libtest.struct.TestStructLongLong",
                                                                          "package com.github.zubnix.libtest.struct;\n" +
                                                                          "\n" +
                                                                          "import com.github.zubnix.jaccall.CType;\n" +
                                                                          "import com.github.zubnix.jaccall.Field;\n" +
        ...
        compileTester.compilesWithoutError()
                     .and()
                     .generatesSources(JavaFileObjects.forSourceString("com.github.zubnix.libtest.struct.TestStructLongLong_Jaccall_StructType",
                                                                       "package com.github.zubnix.libtest.struct;\n" +
                                                                       "\n" +
                                                                       "import com.github.zubnix.jaccall.JNI;\n" +
                                                                       "import com.github.zubnix.jaccall.StructType;\n" +
    ...
    public void testUnsignedLongLongField() {
        //given
        final JavaFileObject fileObject = JavaFileObjects.forSourceString("com.github.zubnix.libtest.struct.TestStructUnsignedLongLong",
                                                                          "package com.github.zubnix.libtest.struct;\n" +
                                                                          "\n" +
                                                                          "import com.github.zubnix.jaccall.CType;\n" +
                                                                          "import com.github.zubnix.jaccall.Field;\n" +
                                                                          "import com.github.zubnix.jaccall.Struct;\n" +
                                                                          "\n" +
                                                                          "import static com.github.zubnix.jaccall.CType.UNSIGNED_LONG_LONG;\n" +
                                                                          "\n" +
                                                                          "@Struct(value = {\n" +
        ...
        compileTester.compilesWithoutError()
                     .and()
                     .generatesSources(JavaFileObjects.forSourceString("com.github.zubnix.libtest.struct.TestStructUnsignedLongLong_Jaccall_StructType",
                                                                       "package com.github.zubnix.libtest.struct;\n" +
                                                                       "\n" +
                                                                       "import com.github.zubnix.jaccall.JNI;\n" +
                                                                       "import com.github.zubnix.jaccall.StructType;\n" +
    ...
    public void testFloatField() {
        //given
        final JavaFileObject fileObject = JavaFileObjects.forSourceString("com.github.zubnix.libtest.struct.TestStructFloat",
                                                                          "package com.github.zubnix.libtest.struct;\n" +
                                                                          "\n" +
                                                                          "import com.github.zubnix.jaccall.CType;\n" +
                                                                          "import com.github.zubnix.jaccall.Field;\n" +
        ...
        compileTester.compilesWithoutError()
                     .and()
                     .generatesSources(JavaFileObjects.forSourceString("com.github.zubnix.libtest.struct.TestStructFloat_Jaccall_StructType",
                                                                       "package com.github.zubnix.libtest.struct;\n" +
                                                                       "\n" +
                                                                       "import com.github.zubnix.jaccall.JNI;\n" +
                                                                       "import com.github.zubnix.jaccall.StructType;\n" +
                                                                       ...
                                                                       "    return readFloat(OFFSET_0);\n" +
                                                                       "  }\n" +
                                                                       "\n" +
                                                                       "  public final void field0(final float field0) {\n" +
                                                                       "    writeFloat(OFFSET_0, field0);\n" +
                                                                       "  }\n" +
                                                                       "}"));
    }
    ...
    public void testDoubleField() {
        //given
        final JavaFileObject fileObject = JavaFileObjects.forSourceString("com.github.zubnix.libtest.struct.TestStructDouble",
                                                                          "package com.github.zubnix.libtest.struct;\n" +
                                                                          "\n" +
                                                                          "import com.github.zubnix.jaccall.CType;\n" +
                                                                          "import com.github.zubnix.jaccall.Field;\n" +
                                                                          "import com.github.zubnix.jaccall.Struct;\n" +
                                                                          "\n" +
                                                                          "import static com.github.zubnix.jaccall.CType.DOUBLE;\n" +
                                                                          "\n" +
                                                                          "@Struct(value = {\n" +
                                                                          "             @Field(type = DOUBLE,\n" +
                                                                          "                    name = \"field0\")})\n" +
        ...
        compileTester.compilesWithoutError()
                     .and()
                     .generatesSources(JavaFileObjects.forSourceString("com.github.zubnix.libtest.struct.TestStructDouble_Jaccall_StructType",
                                                                       "package com.github.zubnix.libtest.struct;\n" +
                                                                       "\n" +
                                                                       "import com.github.zubnix.jaccall.JNI;\n" +
                                                                       "import com.github.zubnix.jaccall.StructType;\n" +
                                                                       ...
                                                                       "    return readDouble(OFFSET_0);\n" +
                                                                       "  }\n" +
                                                                       "\n" +
                                                                       "  public final void field0(final double field0) {\n" +
                                                                       "    writeDouble(OFFSET_0, field0);\n" +
                                                                       "  }\n" +
                                                                       "}"));
    }
