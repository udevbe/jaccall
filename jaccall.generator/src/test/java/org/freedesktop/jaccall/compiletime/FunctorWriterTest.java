        ...
        compileTester.compilesWithoutError()
                     ...
                     .generatesSources(JavaFileObjects.forSourceString("PointerCharFunc",
                                       ...
                                       JavaFileObjects.forSourceString("org.freedesktop.libtest.CharFunc_Jaccall_C",
                                                                       ...
                                                                       "  static {\n" +
                                                                       "    JNI.linkFuncPtr(CharFunc_Jaccall_C.class,  \"_invoke\", 2, \"(JB)B\", FFI_CIF);\n" +
                                                                       "  }\n" +
                                                                       "\n" +
                                                                       ...
                                                                       "\n" +
                                                                       "  @Override\n" +
                                                                       "  public byte invoke(byte value) {\n" +
                                                                       "    return _invoke(this.address, value);\n" +
                                                                       "  }\n" +
                                                                       "\n" +
                                                                       "  private static native byte _invoke(long address, byte value);\n" +
                                                                       "}"),
                                       JavaFileObjects.forSourceString("org.freedesktop.libtest.CharFunc_Jaccall_J",
                                                                       ...
                                                                       "  private static final long JNI_METHOD_ID = JNI.GetMethodID(CharFunc.class, \"invoke\", \"(B)B\");\n" +
                                                                       "\n" +
