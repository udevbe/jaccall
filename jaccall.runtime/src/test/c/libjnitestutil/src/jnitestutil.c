...
#include "org_freedesktop_jaccall_JNITestUtil.h"
...
JNIEXPORT
jlong
JNICALL Java_org_freedesktop_jaccall_JNITestUtil_byteArrayAsPointer(JNIEnv *env, jclass clazz,
...
JNIEXPORT
jlong
JNICALL Java_org_freedesktop_jaccall_JNITestUtil_pointerOfPointer(JNIEnv *env, jclass clazz, jlong pointer){
...
JNIEXPORT
jbyte
JNICALL Java_org_freedesktop_jaccall_JNITestUtil_execCharTest(JNIEnv *env, jclass clazz, jlong func_ptr, jbyte value){
...
JNIEXPORT
jbyte
JNICALL Java_org_freedesktop_jaccall_JNITestUtil_execUnsignedCharTest(JNIEnv *env, jclass clazz, jlong func_ptr, jbyte value){
...
JNIEXPORT
jshort
JNICALL Java_org_freedesktop_jaccall_JNITestUtil_execShortTest(JNIEnv *env, jclass clazz, jlong func_ptr, jshort value){
...
JNIEXPORT
jshort JNICALL
Java_org_freedesktop_jaccall_JNITestUtil_execUnsignedShortTest(JNIEnv *env, jclass clazz, jlong func_ptr, jshort value){
...
JNIEXPORT
jint
JNICALL Java_org_freedesktop_jaccall_JNITestUtil_execIntTest(JNIEnv *env, jclass clazz, jlong func_ptr, jint value){
...
JNIEXPORT
jint
JNICALL Java_org_freedesktop_jaccall_JNITestUtil_execUnsignedIntTest(JNIEnv *env, jclass clazz, jlong func_ptr, jint value){
...
JNIEXPORT
jlong
JNICALL Java_org_freedesktop_jaccall_JNITestUtil_execLongTest(JNIEnv *env, jclass clazz, jlong func_ptr, jlong value){
...
JNIEXPORT
jlong
JNICALL Java_org_freedesktop_jaccall_JNITestUtil_execUnsignedLongTest(JNIEnv *env, jclass clazz, jlong func_ptr, jlong value){
...
JNIEXPORT
jlong
JNICALL Java_org_freedesktop_jaccall_JNITestUtil_execLongLongTest(JNIEnv *env, jclass clazz, jlong func_ptr, jlong value){
...
JNIEXPORT
jlong
JNICALL Java_org_freedesktop_jaccall_JNITestUtil_execUnsignedLongLongTest(JNIEnv *env, jclass clazz, jlong func_ptr, jlong value){
...
JNIEXPORT
jfloat
JNICALL Java_org_freedesktop_jaccall_JNITestUtil_execFloatTest(JNIEnv *env, jclass clazz, jlong func_ptr, jfloat value){
...
JNIEXPORT
jdouble
JNICALL Java_org_freedesktop_jaccall_JNITestUtil_execDoubleTest(JNIEnv *env, jclass clazz, jlong func_ptr, jdouble value){
...
JNIEXPORT
jlong
JNICALL Java_org_freedesktop_jaccall_JNITestUtil_execPointerTest(JNIEnv *env, jclass clazz, jlong func_ptr, jlong value){
...
JNIEXPORT
jlong
JNICALL Java_org_freedesktop_jaccall_JNITestUtil_execStructTest(JNIEnv *env, jclass clazz, jlong func_ptr, jlong tst,
...
JNIEXPORT
jlong
JNICALL Java_org_freedesktop_jaccall_JNITestUtil_execStructTest2(JNIEnv *env, jclass clazz, jlong func_ptr, jlong tst,
                                                                   jbyte field0, jshort field1, jlong field2, jlong field3,
                                                                   jlong embedded_field0, jfloat embedded_field1){
...
JNIEXPORT
jlong
JNICALL Java_org_freedesktop_jaccall_JNITestUtil_execUnionTest(JNIEnv *env, jclass clazz, jlong func_ptr, jlong tst, jint field0, jfloat field1){
 ...
 */
JNIEXPORT
jlong JNICALL Java_org_freedesktop_jaccall_JNITestUtil_execUnionTest2(JNIEnv *env, jclass clazz, jlong func_ptr, jlong tst, jint field0){
...
Java_org_freedesktop_jaccall_JNITestUtil_allocStructFp(JNIEnv *env, jclass clazz){
