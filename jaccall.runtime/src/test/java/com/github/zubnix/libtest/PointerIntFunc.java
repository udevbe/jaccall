...
public abstract class PointerIntFunc extends PointerFunc<PointerIntFunc> implements Testing.IntFunc {
    ...
    @Nonnull
    public static PointerIntFunc nref(@Nonnull final Testing.IntFunc function) {
