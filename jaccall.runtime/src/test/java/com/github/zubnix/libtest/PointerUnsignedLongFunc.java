...
public abstract class PointerUnsignedLongFunc extends PointerFunc<PointerUnsignedLongFunc> implements UnsignedLongFunc {
    ...
    @Nonnull
    public static PointerUnsignedLongFunc nref(@Nonnull final UnsignedLongFunc function) {
